...
class BackToTopAdvnaced
{
	...
	public function loadStyles ()
	{
		...
		wp_enqueue_style('back-to-top-advanced-style', plugins_url( '../assets/style.css', __FILE__ ), array(),'1.1', 'all');
		wp_enqueue_script('back-to-top-advanced-js', plugins_url( '../assets/script.js', __FILE__ ),array('jquery','jquery-core'),'1.1',false);		
	}
	...
	public function outputHellpers() {
		...
		if (is_single() || is_page() && is_admin()) {
			?><div class="button-advanced"><a href="<?php echo get_edit_post_link(get_the_ID()); ?>"><i class="fa fa-pencil-square-o"></i></a></div><?php
		}
	}
